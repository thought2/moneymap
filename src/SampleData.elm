    ...
    let
        nodes =
            ...
            , Graph.Node 2
                ...
                , position = Point2d.fromCoordinates ( 30.0, 412.0 )
                }
            , Graph.Node 3
                { name = "Dean Heller"
                , entity = Politician { party = Republican, organ = Senate }
            ...
            , Graph.Node 5
                { name = "John Barrasso"
                , entity = Politician { party = Republican, organ = Senate }
                , position = Point2d.fromCoordinates ( 439.0, 500.0 )
                }
            , Graph.Node 5
                { name = "John Barrasso"
                , entity = Politician { party = Republican, organ = Senate }
            ...
            , Graph.Node 7
                { name = "Henry Cuellar"
                , entity = Politician { party = Democrat, organ = House }
                , position = Point2d.fromCoordinates ( 30.0, 100.0 )
                }
            , Graph.Node 8
                { name = "Cindy Hyde-Smith"
                , entity = Politician { party = Republican, organ = Senate }
                , position = Point2d.fromCoordinates ( 129.0, 120.0 )
                }
            , Graph.Node 9
                { name = "Luther Strange"
                , entity = Politician { party = Republican, organ = Senate }
                , position = Point2d.fromCoordinates ( 9.0, 16.0 )
                }
            , Graph.Node 10
                { name = "Deb Fischer"
                , entity = Politician { party = Republican, organ = Senate }
                , position = Point2d.fromCoordinates (470.0, 310.0 )
                }
            ]
